...
% text(min(x)-10, max(y)-3*tmp, ['p = ' num2str(pValue)], 'HorizontalAlignment', 'left',FontName='times new roman',FontSize=15);
text(min(x)-10, max(y)-3*tmp, ['p = 0.959'], 'HorizontalAlignment', 'left',FontName='times new roman',FontSize=15);
...
% text(min(x)-0.02, max(y)-2.3*tmp, ['p = ' num2str(pValue)], 'HorizontalAlignment', 'left',FontName='times new roman',FontSize=15);
text(min(x)-0.02, max(y)-2.3*tmp, ['p < 0.001'], 'HorizontalAlignment', 'left',FontName='times new roman',FontSize=15);
...
% text(min(x)+3, max(y)-3.8*tmp, ['p = ' num2str(pValue)], 'HorizontalAlignment', 'left',FontName='times new roman',FontSize=15);
text(min(x)+3, max(y)-3.8*tmp, ['p = 0.191'], 'HorizontalAlignment', 'left',FontName='times new roman',FontSize=15);
text(30, 111,"(c)",'FontSize',18,'FontWeight','bold','FontName','times new roman')
...
% text(min(x), max(y)-3.2*tmp, ['p = ' num2str(pValue)], 'HorizontalAlignment', 'left',FontName='times new roman',FontSize=15);
text(min(x), max(y)-3.2*tmp, ['p < 0.001'], 'HorizontalAlignment', 'left',FontName='times new roman',FontSize=15);
